...
export class SeedService implements OnApplicationBootstrap {
    ...
    async onApplicationBootstrap() {
        ...
        const categories = [
            { name: 'Abaya Exclusive', slug: 'abaya-exclusive', description: 'Premium Abayas for all occasions' },
            { name: 'Gamis Modern', slug: 'gamis-modern', description: 'Elegant and modern modest dresses' },
            { name: 'Koko / Kurta', slug: 'koko-kurta', description: 'Stylish and comfortable men wear' },
            { name: 'Khimar & Pashmina', slug: 'khimar-pashmina', description: 'High quality headwear' },
        ];
